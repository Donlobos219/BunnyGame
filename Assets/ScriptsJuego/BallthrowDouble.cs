...
public class BallthrowDouble : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0)&& !onGround && canDoubleJump)
            {             
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            if (Input.GetMouseButtonUp(0) && !onGround && canDoubleJump)
        {         
            ...
            {
                ball.velocity = transform.forward * shootpower2;
                Line.gameObject.SetActive(false);
                canDoubleJump = true;
            }
