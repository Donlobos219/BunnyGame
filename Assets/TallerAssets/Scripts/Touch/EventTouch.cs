...
namespace Taller
{
    ...
    public static class EventTouch
    {
        ...
        public static TouchEventResult OnSwipeFinished, OnDrag, OnDragBegin, OnDragFinished,OnHold;
        ...
        private static void TouchHold(Vector2 screenTouchPosition)
        {
            if (swipeResult == null) return;
         
            Debug.Log("holding"+screenTouchPosition);
            GetTouchStatus(screenTouchPosition);
            if (OnHold == null) {
               // print("onhold")
            }
